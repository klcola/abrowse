ABrowse.view.GeneModelDenseView = function (genomeBrowser) {
...
ABrowse.view.GeneModelDenseView.entryClickEventHandler = function (event) {
...
ABrowse.view.GeneModelDenseView.prototype = new ABrowse.view.View();

ABrowse.view.GeneModelDenseView.prototype.applyColorSchema = function (colorSchema) {
...
ABrowse.view.GeneModelDenseView.prototype.drawTranscript = function (transcript, level, trackName) {
    ...
    if (!entryAnchor) {
        ...
        entryAnchor.addEventListener("click", ABrowse.view.GeneModelDenseView.entryClickEventHandler, false);
...
ABrowse.view.GeneModelDenseView.prototype.drawEntry = function (gene, level, trackName) {
...
ABrowse.view.GeneModelDenseView.prototype.drawBlock = function (blockResponse, trackName) {
...
ABrowse.view.GeneModelDenseView.prototype.render = function (trackResponse, top) {
...
ABrowse.view.GeneModelDenseView.prototype.slide = function (trackSvgGroup, slideStepInPixels, top) {
